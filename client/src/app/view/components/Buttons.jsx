...
const SmallBtn = styled(PulseDiv)`
	...
	background: #008500;
	transition: 1s ease;
	box-shadow: 0 0 10px #008500, 0 0 40px #008500, 0 0 80px #008500;
`;
	...
	return (
		<BtnWrapper>
			{!props.vS ? (
				...
				<VotedBtn num={props.num}>{props.entry}</VotedBtn>
			) : (
				<BtnAfterVoting num={props.num}>{props.entry}</BtnAfterVoting>
			)}
		</BtnWrapper>
	);
};
